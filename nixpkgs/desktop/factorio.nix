...
let
  ...
  authenticatedFetch = callPackage <nixpkgs/pkgs/games/factorio/fetch.nix> { inherit username password; };

  fetch = rec {
    url = "https://www.factorio.com/get-download/${version}/${releaseType}/${arch.inUrl}";
    name = "factorio_${releaseType}_${arch.inTar}-${version}.tar.gz";
    x64 = {
      headless = fetchurl        { inherit name url; sha256 = "0bx3fq46781vv9vr0ciyckaskksjrqikvcdv1yz0wj8mrb2j08cw"; };
      alpha = authenticatedFetch { inherit      url; sha256 = "0hwick9ydfwkxii2s3l2spp59331fcciap7j9yx9vrmmvy7aykf0"; };
    };
    i386 = {
      headless = abort "Factorio 32-bit headless binaries are not available for download.";
      alpha = authenticatedFetch { inherit      url; sha256 = "0iwhachp1z02w19x5y70qy3b0yp79dspawkcygdfna5cfqrybvx6"; };
    };
  };
