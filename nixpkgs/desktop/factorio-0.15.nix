...
let
  ...
  fetch = rec {
    ...
    x64 = {
      alpha = /home/rotsor/Downloads/factorio_alpha_x64_0.15.34.tar.xz; # authenticatedFetch { inherit      url; sha256 = "0hwick9ydfwkxii2s3l2spp59331fcciap7j9yx9vrmmvy7ayka0"; };
    };
  };
