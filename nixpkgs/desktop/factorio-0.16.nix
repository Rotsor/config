...
with stdenv.lib;
let
  # 0.16.16: 0g4ygrgbhsyfr87g2h370r35gwz8xg5bqb3lkjkjns3vfsq54qri
  # 0.16.18: 19hw0x90l7fh6kz8pfw6z7m7j3n7p4z0nncixgckw2bkhyw6bxix
  version = "0.16.16";
  ...
  fetch = rec {
    ...
    x64 = {
      alpha = authenticatedFetch { inherit      url; sha256 = "0g4ygrgbhsyfr87g2h370r35gwz8xg5bqb3lkjkjns3vfsq54qri"; };
    };
  };
